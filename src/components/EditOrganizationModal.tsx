...
export default function EditOrganizationModal({ organization, onClose, onOrganizationUpdated }: EditOrganizationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedOrganization = await dataService.updateOrganization(organization.id, validatedData);
